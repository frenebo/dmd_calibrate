...
def get_background_and_white_images(core, raspi_controller, workdir):
...
def calibrate(core, raspi_controller, workdir):
    ...
    get_background_and_white_images(core, raspi_controller, workdir)
    ...
    for circle_dmd_y in grid_y_positions:
        for circle_dmdx in grid_x_positions:
